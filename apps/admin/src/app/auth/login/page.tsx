    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-900">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-900 mt-2">Company Admin</h1>
          <p className="text-sm text-stone-500 mt-1">회사 관리자 전용</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-stone-900 text-white rounded-lg py-2 text-sm font-medium hover:bg-stone-800 disabled:opacity-50 transition-colors mt-2"
          >
            {loading ? "로그인 중..." : "로그인"}
          </button>
        </form>
